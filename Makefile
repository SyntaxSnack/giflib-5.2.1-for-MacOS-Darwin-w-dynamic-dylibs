...
libgif.so: $(OBJECTS) $(HEADERS)
	$(CC) $(CFLAGS) -dynamic -dead_strip -Wl,-dead_strip,-dead_strip_dylibs -shared $(LDFLAGS) -flto -Wl,-undefined,dynamic_lookup -o libgif.dylib $(OBJECTS)

libgif.a: $(OBJECTS) $(HEADERS)
	$(AR) rcs libgif.a $(OBJECTS)

libutil.so: $(UOBJECTS) $(UHEADERS)
	$(CC) $(CFLAGS) -dynamic -dead_strip -Wl,-dead_strip,-dead_strip_dylibs -shared $(LDFLAGS) -flto -Wl,-undefined,dynamic_lookup -o libutil.dylib $(UOBJECTS)
